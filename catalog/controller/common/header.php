...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$information = $this->model_catalog_information->getInformation(6);
		if ($information) {
			$data['delivery'] = $this->url->link('information/information&information_id=' . $information['information_id']);
			$data['text_delivery'] = $information['title'];
		}
